...
const About = ( props ) => {
  const Content = {
    "about": {
      "subtitle": "Hikayemiz",
      "title": "Her Zaman En İyi Hizmetleri Sunuyoruz",
      "text_1": "Dijital Pazarlama konusunda kendilerine güvenen ve hırslı bir ekip olarak başladığımız bu yolda 300’ün üzerinde müşteri portföyü, başta SEO olmak üzere, Google Adwords,Sosyal Medya Çalışmaları ve E Ticaret Site Kurulumu birlikte müşterilerimizi Dijital Dünya’ya taşıyoruz.Sertifikalı ve Uzman ekibimizle daima yenilik mottosuyla müştelerimize hizmet vermekteyiz. Time SEO Ajansı bir Time Group markasıdır.",
