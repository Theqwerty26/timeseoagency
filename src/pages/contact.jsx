    ...
    "info": [
      {
        ...
        "label": "E-Mail Adresimiz",
        "value": "info@timeseoagency.com.tr"
      },
      {
        "icon": "img/icons/7.svg",
        "label": "Pzt - Cmt : 09.00 - 17.00",
        "value": "+90 262 606 1238"
      }
    ]
  }
  ...
  return (
    <Layouts>
          ...
          <Formik
            ...
            onSubmit = {( values, { setSubmitting } ) => {
                ...
                fetch(form.action, {
                    ...
                    if (response.ok) {
                        status.innerHTML = "Formunuz Gönderildi! Teşekkür ederiz";
                        form.reset()
                    } else {
                    ...
                    status.innerHTML = "Sanırım formunuzda bir hata oluştu.Lütfen tekrar deneyin"
                });
            ...
            <form onSubmit={handleSubmit} id="contactForm" action={appData.settings.formspreeURL}>
              <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                      <p className="mil-text-sm mil-mb-30">*Bilgileriniz hiç bir koşulda 3.şahışlarla paylaşılmamaktadır.</p>
                  </div>
                  <div className="col-lg-6">
      ...
      <div className="mil-map-frame">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.0058514181746!2d29.91995367651966!3d40.76189603455869!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cb4520899dae51%3A0xb11e9a62d8c07215!2sTime%20SEO%20Ajans%C4%B1!5e0!3m2!1str!2s!4v1776002472932!5m2!1str!2s" 
          width={600} 
          height={450} 
          style={{ border: 0 }} 
          allowFullScreen
